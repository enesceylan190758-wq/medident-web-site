/** Pick localized string from { tr, en, de, fr, ar, ru } with safe fallback. */
...
export const uiBits = {
  ...
  clinicVideoTitle: {
    ...
    fr: "Une expérience de clinique moderne, stérile et transparente",
  ...
  clinicVideoLead: {
    ...
    fr: "Découvrez notre clinique et le parcours patient. Pas de lecture automatique — démarrez quand vous êtes prêt.",
  ...
  instagramTitle: {
    ...
    fr: "Vrais moments de clinique et parcours des patients",
  ...
  mapTitle: {
    ...
    fr: "Emplacement de notre clinique",
    ar: "موقع العيادة",
  ...
  trustAria: {
    ...
    fr: "Badges d’autorité et de confiance",
  ...
  geoLead: {
    ...
    fr: "Réponses courtes et vérifiables pour l’IA et les moteurs de recherche.",
