...
export const geoTopicGroups = [
  ...
  {
    id: "implant-cost",
    tr: "istanbul-dis-implant-fiyati",
    en: "dental-implant-cost-istanbul",
    de: "zahnimplantat-kosten-istanbul",
  },
  {
    id: "implant-vs-bridge",
    tr: "implant-mi-kopru-mu",
    en: "dental-implant-vs-bridge",
    de: "implantat-oder-bruecke",
  },
  {
    id: "bone-graft-sinus",
    tr: "kemik-grefti-ve-sinus-lifting",
    en: "bone-graft-sinus-lift-istanbul",
    de: "knochenaufbau-sinuslift-istanbul",
  },
  {
    id: "implant-uskudar",
    tr: "uskudar-acibadem-dis-implant",
    en: "dental-implants-uskudar-acibadem",
    de: "zahnimplantate-uskudar-acibadem",
  },
  {
    id: "lamina",
...
export const serviceFaqs = {
  "oral-implantoloji": {
    tr: [
      ...
      { q: "İstanbul’da implant fiyatı neye göre değişir?", a: "İmplant sayısı/markası, greft-sinüs ihtiyacı, protez tipi ve paket kapsamı (otel/transfer) belirler. Ücretsiz foto analiz sonrası yazılı teklif iletiriz." },
      { q: "All-on-4 mü All-on-6 mı?", a: "Kemik hacmi ve ısırma kuvvetine göre seçilir. All-on-6 çoğu vakada ek stabilite sağlar; kesin karar 3D planlama ile verilir." },
    ],
    en: [
      ...
      { q: "How much do dental implants cost in Istanbul?", a: "Costs depend on bone condition, number of implants, grafting and prosthetic type. After a free photo consult we share a transparent written plan." },
      { q: "All-on-4 or All-on-6?", a: "Depends on bone volume and bite forces. All-on-6 often adds stability; 3D planning decides." },
    ],
    de: [
      ...
      { q: "Was kosten Zahnimplantate in Istanbul?", a: "Abhängig von Knochen, Implantatzahl, Aufbau und Zahnersatz. Nach kostenloser Foto-Beratung erhalten Sie einen transparenten Plan." },
      { q: "All-on-4 oder All-on-6?", a: "Je nach Knochen und Bisskraft. All-on-6 oft stabiler; Entscheidung nach 3D-Planung." },
    ],
  },
  "implantoloji-implant-tedavisi": {
    tr: [
      ...
      { q: "İmplant mı köprü mü tercih edilmeli?", a: "İmplant komşu dişleri küçültmeden restore eder ve kemiği destekler; köprü yan dişlerin aşındırılmasını gerektirebilir. Karar muayene ile verilir." },
      { q: "Kemik grefti gerekir mi?", a: "Yalnızca kemik yetersizse. 3D görüntüleme ile anlaşılır; ihtiyaç teklifte peşinen belirtilir." },
    ],
    en: [
      ...
      { q: "Implant or bridge?", a: "Implants restore a gap without grinding neighbours and help preserve bone; bridges often need adjacent teeth prepared." },
    ],
    de: [
      ...
      { q: "Implantat oder Brücke?", a: "Implantate schließen die Lücke ohne Beschleifen der Nachbarn und stützen den Knochen; Brücken erfordern oft Präparation." },
    ],
  },
