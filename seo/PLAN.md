...
Son güncelleme: 2026-09-11 (oturum: Auto)  
PR: (açılacak — `seo/mirror-wave-2`)
...
| 2b | Kalan primary mirror hizmetler (wave 2) | **bitti (PR)** | +5 hizmet / 14 blog 301 |
...
| 10 | turkey teeth genişlet (~500→~2400) | **bitti** | PR #33; reviewer 2026-09-11 |
| 11 | Türev: turkey-teeth-meaning / -risks / -vs-veneers | **ertelendi** | Hub zaten 3 açıyı kapsıyor → kannibal; hub index+GSC sonra yeniden değerlendir |
