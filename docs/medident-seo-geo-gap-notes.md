...
*Son güncelleme: 2026-09-24 · Domain: https://medidentistanbul.com*  
...
Kaynak sayıları (repo): GEO packs **64** (tr 22 / en 23 / de 19 / ar 0 / ru 0) · blog generated **53** (main 52 + bu PR 1; açık taslak PR’lar henüz main’de değil).
...
- Fiyat şeffaflığı: why cheaper (EN + DE GEO mevcut; TR uzun form blog 2026-09-24)
...
1. **DE Nachsorge / Garantie-Rahmen** — UK aftercare var; DE eşdeğer “Zahnbehandlung Türkei Nachsorge” yok (garanti vaadi yasak; süreç/çerçeve anlat). Blog katmanı PR #57 taslakta.
...
| 7 | GEO TR+EN+DE | Türkiye'de diş tedavisi fiyatları neden daha ucuz — şeffaflık ve güven çerçevesi. Garanti/kesin sonuç yok. | **uretildi** (2026-09-24) | TR blog `turkiyede-dis-tedavisi-fiyatlari-neden-farklidir`. EN/DE GEO zaten var (`why-is-dental-treatment-cheaper-in-turkey`, `warum-ist-zahnbehandlung-in-der-tuerkei-guenstiger`) — yeni URL açılmadı (kannibalizasyon). |
...
## Koşu 2026-09-24 (günlük blog otomasyonu)

- Pazar: **TR** — backlog #7 (bekliyor sırasının en üstü); konu tahmin edilmedi
- Satır: GEO TR+EN+DE “Türkiye'de diş tedavisi fiyatları neden daha ucuz — şeffaflık ve güven çerçevesi”
- Üretilen: `/blog/turkiyede-dis-tedavisi-fiyatlari-neden-farklidir/` (işletme gideri + teklif okuma; somut TL/USD/EUR yok; “ucuz” reklam dili yok)
- EN/DE yeni sayfa yok: mevcut GEO `/en/geo/why-is-dental-treatment-cheaper-in-turkey/` ve `/de/geo/warum-ist-zahnbehandlung-in-der-tuerkei-guenstiger/` aynı soruyu zaten cevaplıyor
- Canlı smoke: yok (PR taslak, merge/deploy yok)
- Kapanan gap: TR uzun form fiyat-şeffaflığı / güven çerçevesi. Backlog tablosunda bekliyor satırı kalmadı.
- Açık kalan: AR/RU native GEO; insan araştırması olmadan yeni konu eklenmez
- GSC (merge sonrası): `https://medidentistanbul.com/blog/turkiyede-dis-tedavisi-fiyatlari-neden-farklidir/`
- İnsan onayı: `reviewer` / `reviewedAt` boş — `npm run seo:approve -- --slugs turkiyede-dis-tedavisi-fiyatlari-neden-farklidir --by "Dr. …"`
